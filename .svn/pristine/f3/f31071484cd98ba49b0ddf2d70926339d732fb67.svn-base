...
* CAI convolutional neural network API and
* TEasyLearnAndPredict neural network API.

These are the APIs:
* A convolutional neural network API implemented at libs/uconvolutionneuralnetwork.pas.
* TEasyLearnAndPredict neural network API implemented at libs/ubyteprediction.pas.
...
* CIFAR-10 file support API implemented at libs/ucifar10.pas.
...
* CIFAR-10 classification examples:
  * /testcnnalgo/testcnnalgo.lpr
  * A number of CIFAR-10 classification examples at /experiments.
* Increase image resolution from 32x32 to 256x256 RGB at /IncreaseResolution.
* Web server that allows remote/distributed NN computing and backpropagation at /NeuralWebServer.
* Cellular Automatas:
...
* OpenCL convolution implemented at:
  experiments/visualCifar10OpenCL/
...
Implemented at libs/uconvolutionneuralnetwork.pas, this unit offers various layers.
